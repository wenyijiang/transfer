...
void cBaseControllerMACE::BuildActorAction(const Eigen::VectorXd& params, int a_id, tAction& out_action) const//////////////////////////////////////////////////////ready
{
	...
	SetOptParams(action_frag, out_action.mParams);////////////////////////////////////////////////////out_action.mParams
}
